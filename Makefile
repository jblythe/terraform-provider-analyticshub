...
export BASE_BINARY_NAME=terraform-provider-analyticshub_v$(VERSION)
...
.PHONY: install
install:
	@go build -o ~/.terraform.d/plugins/registry.terraform.io/jblythe/analyticshub/${VERSION}/darwin_arm64/terraform-provider-analyticshub